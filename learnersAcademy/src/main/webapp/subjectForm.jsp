			...
			<div class="mainContent">  
				...
				                <td>
					...
					                    <c:forEach var="_class" items="${listClasses}"> 
							                <option value ="${_class.id}" <c:if test="${subject.classid == _class.id}">selected</c:if>>${_class.name}</option>
							            </c:forEach>
									</select>
				                </td>
				            </tr>          
				...
				                <th>Name: </th>
				                <td>
				                    <input type="text" name="name" size="45" value="<c:out value='${subject.name}' />" />
				                </td>
				            </tr>
				            <tr>
